...
return (
          ...
          source={require('./Components/imageAssets/home_bg.png')}>
          ...
          onPress={this.redirect.bind(this,'myInventory',this.props.authData)}
          >
          <Text style={styles.homeButtonText}>My Inventory</Text>
          </TouchableHighlight>
